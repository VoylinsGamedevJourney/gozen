...
1. Go to the [Issues tab](https://codeberg.org/gozen/gozen/issues);
...
1. **Fork the repo:**
    * [Fork the GoZen project from Codeberg](https://codeberg.org/gozen/gozen/fork) to create your own copy of GoZen to work in;
